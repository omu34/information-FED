...
<div class="bg-white dark:bg-gray-950">
    <div class="flex mx-auto justify-center gap-x-12 pt-6 pb-10">
        <!-- Button: Share This -->
        <button class="flex items-center px-4 py-2 text-base font-medium leading-5 bg-[#16661e] uppercase text-white border border-transparent rounded-xl shadow-sm  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            Share
            <!-- Chevron Icon -->
        ...
        <div class="flex items-center space-x-6">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=https://your-article-url.com" target="_blank" rel="noopener noreferrer">
                <svg width="21" class="h-7 w-7" height="20" viewBox="0 0 21 20" class="w-6 h-6 text-blue-900" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20.2856 10C20.2856 4.48 15.8056 0 10.2856 0C4.76564 0 0.285645 4.48 0.285645 10C0.285645 14.84 3.72564 18.87 8.28564 19.8V13H6.28564V10H8.28564V7.5C8.28564 5.57 9.85564 4 11.7856 4H14.2856V7H12.2856C11.7356 7 11.2856 7.45 11.2856 8V10H14.2856V13H11.2856V19.95C16.3356 19.45 20.2856 15.19 20.2856 10Z" fill="#16661e"/>
                    </svg>
            </a>
