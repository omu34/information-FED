...
<div class="bg-center py-12 sm:py-16 bg-[url('bg-light.png')] dark:bg-[url('bg-dark.png')]">
    <div class="mx-auto lg:px-0 px-10 max-w-7xl">
        <div class="mx-auto flex flex-col items-center sm:flex-row sm:justify-between mb-8">
            <h2 class="text-4xl lg:pb-0 pb-5 font-medium tracking-tight text-gray-900 dark:text-white sm:text-3xl">Videos</h2>
            <a href="/single-video" class="text-white bg-[#262B36] dark:bg-[#20074e] focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-base px-5 py-2.5 text-center inline-flex items-center me-2 mb-2 hover:text-gray-200 hover:bg-[#1C1F2A] dark:hover:bg-[#19325A] dark:hover:text-gray-200 transition-colors duration-300">
        ...
        <div class="mx-auto grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-4 lg:mx-0 lg:max-w-none lg:grid-cols-4">
            @for($i = 0; $i < 4; $i++)
                <article class="relative isolate flex flex-col transition-transform transform hover:scale-105 justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-8 pt-44 sm:pt-60 lg:pt-56 h-full">
                    <img src="/logo.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">
