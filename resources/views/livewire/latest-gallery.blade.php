<div class="bg-center py-12 sm:py-16 bg-[url('bg-light.png')] dark:bg-[url('bg-dark.png')]">
    <div class="mx-auto lg:px-0 px-10 max-w-7xl">
        <div class="mx-auto flex flex-col items-center sm:flex-row sm:justify-between mb-8 ">
            <h2 class="text-4xl font-normal tracking-tight lg:pb-0 pb-5 text-gray-900 dark:text-white sm:text-3xl">Gallery</h2>
            <a href="/single-gallery" class="text-white bg-[#262B36] dark:bg-[#20074e] focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-base px-5 py-2.5 text-center inline-flex items-center me-2 mb-2 hover:text-gray-200 hover:bg-[#1C1F2A] dark:hover:bg-[#19325A] dark:hover:text-gray-200 transition-colors duration-300">
                <span class="transition-transform duration-300 ease-in-out">More Info</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ml-1.5 transition-transform duration-300 ease-in-out transform translate-x-0 hover:translate-x-1">
        ...
        <div class="mx-auto  grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-4 lg:mx-0 lg:max-w-none lg:grid-cols-4">
            ...
            <article  class="relative isolate flex flex-col transition-transform transform hover:scale-105 justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-8 pt-44 sm:pt-60 lg:pt-56">
                <img src="/logo.jpg"
                ...
                <h3 class="mt-3 text-base font-normal leading-6 text-white">
                    <a href="/single-gallery">
                        ...
                        Africa Information 2024 (Nairobi)
                    </a>
                </h3>
