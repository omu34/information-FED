<div class="bg-white dark:bg-gray-950 bg-center py-6 sm:py-8">
    <div class="mx-auto lg:px-0 px-10 max-w-7xl">
        ...
        <article  class="relative isolate flex flex-col transition-transform transform hover:scale-105 justify-end overflow-hidden rounded-2xl bg-gray-900 px-4 pb-8 pt-44 sm:pt-60 lg:pt-56">
                <img src="/ojeh.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover">
                ...
                <h3 class="mt-3 text-base font-normal leading-6 text-white">
                    <a href="/single-blog">
                        ...
                        Africa Information 2024 (Nairobi, Kenya)
                    </a>
                </h3>
