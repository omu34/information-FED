<div class="bg-white dark:bg-gray-950">
    <div class="bg-[#01091e] py-5">
       <div class="lg:px-0 px-10 mx-auto max-w-7xl">
            <div class="py-2 sm:flex sm:justify-between items-center">
                <!-- 1/3 Section (Quick Links) -->
                <div class="sm:w-1/4">
                    <h2 class="text-4xl font-normal tracking-tight lg:pb-0 pb-5 text-[#f5f8f5] sm:text-5xl">Popular Links
                    </h2>
                </div>
                ...
                <nav class="sm:w-3/4 flex flex-col sm:flex-row sm:justify-between sm:items-center">
                    @for($i = 0; $i < 4; $i++)
                    <a href="#" class="flex text-base w-50 items-center text-[#f5f8f5] font-bold hover:text-gray-900 py-2 px-3">
                        <img src="/badge.svg" class="w-12 h-12 mr-3" alt="">
                       <span class="w-25 text-base">Information</span>
                    </a>
                    @endfor
        ...
        <div class="mx-auto px-10  py-6">
            <div class="grid grid-cols-2 mx-auto text-center justify-center  sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-20">
                ...
                <a href="#" class="flex items-center">
                    <svg width="19" height="18" class="text-[#09225f]" viewBox="0 0 19 18" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
    ...
    <div class="mx-auto  max-w-7xl lg:px-0 px-10 py-6">
        <div class="flex flex-row justify-center gap-x-20">
            ...
            <div class="w-full sm:w-1/2">
                <h3 class="text-xl text-[#16661e] dark:text-[#09225f] font-semibold mb-2">Categories</h3>
                <nav class="flex flex-col sm:flex-row gap-x-6">
                    @for($i = 0; $i < 4; $i++)
                    <a href="#" class="text-gray-800 dark:text-white hover:underline hover:underline-offset-4 ">Nav 1 Here</a>
                    @endfor
                </nav>
            </div>
            ...
            <div class="w-full sm:w-1/2 sm:mt-0">
                <h3 class="text-xl text-[#16661e] dark:text-[#09225f] font-semibold mb-2">Links</h3>
                <nav class="flex flex-col sm:flex-row gap-x-6">
                    @for($i = 0; $i < 4; $i++)
                    <a href="#" class="text-gray-800 dark:text-white hover:underline hover:underline-offset-4 ">A Link Here</a>
                    @endfor
                </nav>
            </div>
        </div>
    ...
    <div class="mx-auto lg:px-0 px-10 max-w-7xl border rounded border-[#95D6FD] dark:border-white ">
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            ...
            <div class="flex items-start text-left p-4">
                ...
                <div>
                    <h3 class="text-base dark:text-white text-gray-600 font-normal mb-1">YEN</h3>
                    <p class="text-lg font-bold text-[#16661e]">*344#</p>
                </div>
            </div>
            @endfor
