    ...
    <div class="mx-auto lg:px-0 px-10 max-w-7xl">
        <div class="mx-auto grid max-w-2xl auto-rows-fr grid-cols-2 gap-4 sm:mt-4 lg:mx-0 lg:max-w-none lg:grid-cols-4">
            @foreach ($posts as $index => $post)
                <img class="video-image max-w-full shadow-xl object-cover rounded-xl cursor-pointer transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl"
