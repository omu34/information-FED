...
<div class="bg-white dark:bg-gray-950 bg-center py-12 sm:py-16">
    <div class="mx-auto lg:px-0 px-10 max-w-7xl">
        <div class="mx-auto flex flex-col items-center sm:flex-row sm:justify-between mb-8 ">
            <h2 class="text-4xl font-normal tracking-tight lg:pb-0 pb-5 text-gray-900 dark:text-white sm:text-3xl">Media</h2>
            <a href="single-media" class="text-white bg-[#262B36] dark:bg-[#20074e] focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-base px-5 py-2.5 text-center inline-flex items-center me-2 mb-2 hover:text-gray-200 hover:bg-[#1C1F2A] dark:hover:bg-[#19325A] dark:hover:text-gray-200 transition-colors duration-300">
