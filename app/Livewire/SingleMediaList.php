...
class SingleMediaList extends Component
{
    ...
    public $posts = [
        ...
        'https://plus.unsplash.com/premium_photo-1715726070346-2500ef1e0e63?q=80&w=2657&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
        // Add more image URLs as needed
    ];

    public function render()
    {
        return view('livewire.single-media-list');
    }
